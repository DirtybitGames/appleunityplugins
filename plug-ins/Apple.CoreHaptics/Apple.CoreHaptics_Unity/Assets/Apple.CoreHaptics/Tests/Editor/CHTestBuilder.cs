...
namespace Apple.CoreHaptics.UnitTests
{
    public class CHTestBuilder : AppleTestBuilder
    {
        ...
        {
            Debug.Log("com.dirtybit.apple.unityplugin.corehaptics: Modifying test build player options.");
            ...
            Debug.Log("com.dirtybit.apple.unityplugin.corehaptics: Calling base ModifyOptions.");
        ...
        {
            Debug.Log("com.dirtybit.apple.unityplugin.corehaptics: Calling base cleanup.");
            base.Cleanup();
        }
    }
}
